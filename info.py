...
PICS = (environ.get('PICS', 'https://i.postimg.cc/sf9Nt3fq/IMG-20241212-171533-202.jpg')).split() #SAMPLE PIC
...
CODE = (environ.get('CODE', 'https://i.postimg.cc/1RfCPqC4/IMG-20241117-154306-551.jpg'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001933509863')) #Log channel id ( make sure bot is admin )
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002492899588')) #Notification of those who verify will be sent to your channel. Enter the ID of the channel you want to send notification to here.
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001933509863')) # add premium logs channel id
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001933509863') # request channel id ( make sure bot is admin ).
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/krbackup/7') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))

#Channel & Group link 
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/kdmovierequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/KRBackup')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/tg_kdbhai')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/KDMovieUpdates')
